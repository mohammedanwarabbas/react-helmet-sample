...
<nav className="my-4 container navbar navbar-expand-lg navbar-light bg-light rounded-pill">
  <div className="container-fluid">
    <Link className="navbar-brand" to="#">React Helmet Sample</Link>
    ...
    <div className="collapse navbar-collapse" id="navbarNav">
      <ul className="navbar-nav">
        ...
        <li className='nav-item' onClick={() => handleMenuItemClick('contact')}>
          <Link className={`nav-link ${activeMenuItem === 'contact' ? 'active' : ''}`} to="/contact">Contact</Link>
        </li>
